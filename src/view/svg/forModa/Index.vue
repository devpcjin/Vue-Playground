<template>
  <div class="svgo-for-moda-page">
    ...
    <div style="margin-bottom: 1rem">
      <label style="cursor: pointer; user-select: none; font-size: 1.05rem">
        <input
          type="checkbox"
          v-model="showFlags"
    ...
    <div v-if="filteredSvgList.length === 0" class="empty-msg">SVG 파일이 없습니다.</div>
    <div v-else class="svg-list">
      <div v-for="svg in filteredSvgList" :key="svg.path" class="svg-row">
